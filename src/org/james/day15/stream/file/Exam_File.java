package org.james.day15.stream.file;
...
public class Exam_File {
	...
	public static void main(String[] args) throws IOException {
		...
		File folderMake = new File("src/org/james/day15/stream/file/sample");
		...
		public void fileMake() throws IOException {
			File fileMake = new File("src/org/james/day15/stream/file/sample.txt");
			if(!fileMake.exists()) {
	...
	public void fileBasic() {
		File file = new File("C:\\Temp\\Fetility.png");
